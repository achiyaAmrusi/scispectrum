...
class IterativePolyFit(BackgroundEstimator):
    """
    Implementation of the "Baseline correction by improved iterative polynomial fitting with
automatic threshold"
    ...
    def estimate(self, x, y):        
        ...
        for i in range(self.max_iter):
            # Step 1 & 2: Calculate the polynomial fitting result (b_k)
...
class IterativePolyFitWithMinimum(BackgroundEstimator):
    ...
    + local minimum value for fitting.
